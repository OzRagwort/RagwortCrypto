package ozr.encryption.sym.HIGHT;
...
public class HIGHT_CBC {
	...
	//public
	private static int[] chartoint32_for_HIGHT_CBC(byte[] in, int inLen) {
		int[] data;
		int len, i;
	...
	//public
	private static byte[] int32tochar_for_HIGHT_CBC(int in[], int inLen) {
		byte[] data;
		int i;
	...
	//public
	private static int HIGHT_CBC_init( KISA_HIGHT_INFO pInfo, KISA_ENC_DEC enc, byte[] pUserKey, byte[] pbszIV )
	{
		byte i, j;
	...
	//public
	private static int HIGHT_CBC_Process( KISA_HIGHT_INFO pInfo, int[] in, int inLen, int[] out, int[] outLen )
	{
	...
	//public
	private static int HIGHT_CBC_Close( KISA_HIGHT_INFO pInfo, int[] out, int out_offset, int[] outLen )
	{
		int nPaddngLeng;
		int i;
	...
	//public
	private static final class KISA_HIGHT_KEY {
	...
	//public
	private static final class KISA_HIGHT_INFO {
		public int encrypt;
