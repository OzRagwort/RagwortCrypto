...
public class HIGHT_ECB {
	...
	//public
	private static int[] chartoint32_for_HIGHT_ECB(byte[] in, int inLen) {
		int[] data;
		int len, i;
	...
	//public
	private static byte[] int32tochar_for_HIGHT_ECB(int in[], int inLen) {
		byte[] data;
		int i;
	...
	//public
	private static int HIGHT_ECB_init( KISA_HIGHT_INFO pInfo, KISA_ENC_DEC enc, byte[] pUserKey )
	{
		byte i, j;
	...
	//public
	private static int HIGHT_ECB_Process( KISA_HIGHT_INFO pInfo, int []in, int inLen, int []out, int []outLen )
	{
	...
	//public
	private static int HIGHT_ECB_Close( KISA_HIGHT_INFO pInfo, int[] out, int out_offset, int[] outLen )
	{
		int nPaddngLeng;
		int i;
