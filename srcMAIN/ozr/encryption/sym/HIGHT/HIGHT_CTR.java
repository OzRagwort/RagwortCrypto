...
public class HIGHT_CTR {
	...
	//public
	private static int[] chartoint32_for_HIGHT_CTR(byte[] in, int inLen) {
		int[] data;
		int len, i;
	...
	//public
	private static byte[] int32tochar_for_HIGHT_CTR(int in[], int inLen) {
		byte[] data;
		int i;
	...
	//public
	private static void HIGHT_CTR_init( KISA_HIGHT_INFO pInfo, KISA_ENC_DEC enc, byte[] pUserKey, byte[] pbszCTR )
	{
		byte i, j;
	...
	//public
	private static int HIGHT_CTR_Process( KISA_HIGHT_INFO pInfo, int[] in, int inLen, int[] out, int[] outLen ) {
		int []pdwCounter;
		int nCurrentCount = 0;
		int in_offset = 0;
		int out_offset = 0;
	...
	//public
	private static int HIGHT_CTR_Close( KISA_HIGHT_INFO pInfo, int[] out, int out_offset, int[] outLen ) {
