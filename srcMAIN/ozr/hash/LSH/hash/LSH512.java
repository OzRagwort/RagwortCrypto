...
/**
 * LSH512 ?ïåÍ≥†Î¶¨Ï¶? Íµ¨ÌòÑ
 * 
 * ?õå?ìú Í∏∏Ïù¥: 64-bit (8-byte) ?ó∞?áÑ Î≥??àò Í∏∏Ïù¥: 1024-bit (128-byte) Î©îÏãúÏß? Î∏îÎ°ù Í∏∏Ïù¥: 2048-bit
 * (256-byte)
 */
public class LSH512 extends Hash {
	...
	/// ?Ç¨?†Ñ Í≥ÑÏÇ∞?êú 384ÎπÑÌä∏ Ï∂úÎ†•?ö© IV
	...
	/// ?Ç¨?†Ñ Í≥ÑÏÇ∞?êú 512ÎπÑÌä∏ Ï∂úÎ†•?ö© IV
	...
	/**
	 * LSH512 Í∏∞Î≥∏ ?Éù?Ñ±?ûê, 512ÎπÑÌä∏ Ï∂úÎ†•?úºÎ°? ?Ñ§?†ï
	 */
	public LSH512() {
		this(512);
	}
